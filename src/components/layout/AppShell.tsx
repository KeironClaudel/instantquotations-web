      ...
      <header className="app-topbar sticky top-0 z-40">
        <div className="mx-auto flex w-full max-w-none flex-col gap-4 px-4 py-4 sm:px-6 lg:px-8">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div className="app-card flex min-w-0 items-center gap-3 px-4 py-3 sm:px-5 lg:w-auto lg:min-w-[18rem] lg:max-w-[24rem] lg:flex-none">
              <Link
                to="/app"
                className="flex min-w-0 flex-1 items-center gap-3 rounded-2xl"
              >
                {companySettings?.logoUrl ? (
                  <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-[1.25rem] border border-[var(--ip-border)] bg-white/80 shadow-sm dark:bg-slate-950/70">
                    <img
                  ...
                  <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-[1.25rem] bg-slate-950 text-sm font-black tracking-[0.16em] text-white dark:bg-white dark:text-slate-950">
                    IP
                  </div>
                )}

                <div className="min-w-0 flex-1">
                  <div className="truncate text-base font-extrabold tracking-[-0.02em] text-[var(--ip-text)]">
                    {companySettings?.displayName ?? "InstantProforms"}
                  </div>

                  <div className="mt-1 flex flex-wrap items-center gap-2 pb-1 lg:overflow-x-auto lg:flex-nowrap lg:whitespace-nowrap lg:[-ms-overflow-style:none] lg:[scrollbar-width:none] lg:[&::-webkit-scrollbar]:hidden">
              ...
              <button
                ...
                className="app-button-secondary lg:hidden"
              >
                <svg
                  viewBox="0 0 24 24"
                  className="h-5 w-5"
          ...
          <div className="app-card px-3 py-3 sm:px-4 lg:hidden">
